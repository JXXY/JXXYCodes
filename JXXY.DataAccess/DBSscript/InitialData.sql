...
IF @teacherNum = 0 
BEGIN
 INSERT INTO Teacher(Id,Name,MobileNumber,LoginName,[Password],CreatedBy,CreatedDate,UpdatedBy,UpdatedDate,SchoolId)values('BE2C01D8-B259-4653-8F30-3449FFD09D70','System','0000000','sys','sys','system',getdate(),'system',getdate(),'43370629-1F20-415B-A7B3-03B0F004A43C')
END